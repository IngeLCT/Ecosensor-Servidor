...
if _DATA_DIR_OVERRIDE:
    ...
    # El servidor completo conserva sus bases, ajustes y capturas dentro del proyecto.
    # La variante distribuible usa LOCALAPPDATA porque se instala como aplicación.
...
UI_FALLBACK_PORT = int(os.getenv('ECOSENSOR_SERVER_FALLBACK_PORT', '80'))
