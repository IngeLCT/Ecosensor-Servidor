"""Punto de entrada de EcoSensor Servidor con interfaz moderna y actualización OTA local."""
import ctypes
import json
import os
import sys
...
from services.ota_manager import (
    ...
    ota_snapshot,
    start_device_ota,
    start_device_web_assets_update,
    web_asset_file_path,
)
...
os.environ['ECOSENSOR_ACTIVE_PORT'] = str(SELECTED_UI_PORT)
